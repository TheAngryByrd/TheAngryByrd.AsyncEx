...
[<assembly: AssemblyTitleAttribute("TheAngryByrd.AsyncEx.Tests")>]
[<assembly: AssemblyProductAttribute("TheAngryByrd.AsyncEx")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "TheAngryByrd.AsyncEx.Tests"
    let [<Literal>] AssemblyProduct = "TheAngryByrd.AsyncEx"
